<p align="center">
<img width="520" align="center" altlt="Image" src="https://github.com/user-attachments/assets/976efe0d-5d80-495c-835b-93cb6aa2d93a" />
</p>
...
> - All your files will  interpreted/compiled on Ubuntu 20.04 LTS using node 20.x.x and npm 9.x.x
...
> - range (String)
- Each attribute must be stored in an “underscore” attribute version (ex: name is stored in _name)
- For privacy reason, when cloneCar is called on a EVCar object, the object returned should be an instance of Car intead of EVCar
